...
-- ============================================================
-- health_metrics: all scalar health metrics (hypertable)
-- ============================================================
...
-- ============================================================
-- sleep_sessions: aggregated nightly sleep summaries
-- ============================================================
...
-- ============================================================
-- sleep_stages: individual sleep stage segments (hypertable)
-- ============================================================
...
-- ============================================================
-- workouts: workout sessions with summary data
-- ============================================================
...
-- ============================================================
-- workout_heart_rate: HR time-series during workouts (hypertable)
-- ============================================================
...
-- ============================================================
-- workout_routes: GPS route points (hypertable)
-- ============================================================
...
-- ============================================================
-- workout_sets: Alpha Progression set/rep/weight data
-- ============================================================
...
-- ============================================================
-- metric_allowlist: controls which metrics are accepted
-- ============================================================
